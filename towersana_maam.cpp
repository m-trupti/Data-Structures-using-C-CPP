...
void towerOfHanoi(int num_disks, int source[], int destination[], int auxiliary[], int* source_top, int* destination_top, int* auxiliary_top,char source_name, char destination_name, char auxiliary_name) {
    ...
    if (num_disks == 1) {
        ...
        // Move (num_disks - 1) disks from source to auxiliary using destination as auxiliary tower
        ...
        // Move the (num_disks - 1) disks from auxiliary to destination using source as auxiliary tower
